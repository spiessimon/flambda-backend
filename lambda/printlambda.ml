...
let print_debug_uid_table ppf =
  Format.fprintf ppf "\n\n";
  Format.fprintf ppf "Debug UID Information\n";
  Format.fprintf ppf "Type Declarations\n";
  Uid.Tbl.iter (fun uid decl ->
    Format.fprintf ppf "  %a -> %a@." Uid.print uid Type_shape.Type_decl_shape.print decl
  )
  Type_shape.all_type_decls;
  Format.fprintf ppf "\nType Shapes\n";
  Uid.Tbl.iter (fun uid shape ->
    Format.fprintf ppf "  %a -> %a@." Uid.print uid Type_shape.Type_shape.print shape
  )
  Type_shape.all_type_shapes
