...
<<<<<<< HEAD
(** Resume compilation from a .cmr file (generated by -support-lto) and a
    .ltosol file (from -reaper-solve) and produce Cmm code. *)
||||||| parent of 857d23aaae (Support batched -reaper-rebuild invocations)
(** Resume compilation from a .cmr file (generated by -support-lto) and a
    .ltosol file (from -reaper-solve) and produce Cmm code. [paused_imports_cmx]
    are the cmx imports recorded in the paused unit's .cmx file. *)
=======
(** Resume compilation from .cmr files (generated by -support-lto) and a .ltosol
    file (from -reaper-solve), producing Cmm code for one compilation unit at a
    time.
    ...
    of the batch. [paused_imports_cmx] are the cmx imports recorded in the
    paused unit's .cmx file.
...
(** Produce a whole-program Reaper solution from the dependency graphs in the
    given files generated by -support-lto and write it to [ltosol_file]. *)
val reaper_lto_solve : cmr_files:string list -> ltosol_file:string -> unit
