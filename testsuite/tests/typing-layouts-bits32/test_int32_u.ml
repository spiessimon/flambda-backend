...
external unsigned_lt : int32_u -> int32_u -> bool = "%int32#_unsigned_lessthan"
external unsigned_gt : int32_u -> int32_u -> bool = "%int32#_unsigned_greaterthan"
external unsigned_div : int32_u -> int32_u -> int32_u = "%int32#_unsigned_div"
external unsigned_mod : int32_u -> int32_u -> int32_u = "%int32#_unsigned_mod"
external unsafe_unsigned_div : int32_u -> int32_u -> int32_u = "%int32#_unsafe_unsigned_div"
external unsafe_unsigned_mod : int32_u -> int32_u -> int32_u = "%int32#_unsafe_unsigned_mod"
...
let () =
  ...
  let one = #1l in
  let minus_one = -#1l in
  let max_int = #0x7FFFFFFFl in
  let min_int = -#0x80000000l in

  (* Test that -1 (0xFFFFFFFF) > 0 when compared as unsigned *)
  assert (I.unsigned_compare minus_one zero = 1);
  assert (I.unsigned_compare zero minus_one = -1);

  (* Test that min_int (0x80000000) > max_int (0x7FFFFFFF) when compared as unsigned *)
  ...
  let neg_1000 = I.of_int (-1000) in (* 0xFFFFFC18 *)
  let pos_1000 = I.of_int 1000 in
  assert (I.unsigned_compare neg_1000 pos_1000 = 1);
  assert (I.unsigned_compare pos_1000 neg_1000 = -1);
