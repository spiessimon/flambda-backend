...
module Int16_u = struct
  ...
  external of_float32 : (float32[@local_opt]) -> t @@ portable
    = "%int16#_of_float32"
  external of_float32_u : float32_u -> t @@ portable = "%int16#_of_float32#"
  ...
  external to_float32 : t -> (float32[@local_opt]) @@ portable
    = "%float32_of_int16#"
  external to_float32_u : t -> float32_u @@ portable = "%float32#_of_int16#"
...
module Int8_u = struct
  ...
  external of_float32 : (float32[@local_opt]) -> t @@ portable
    = "%int8#_of_float32"
  external of_float32_u : float32_u -> t @@ portable = "%int8#_of_float32#"
  ...
  external to_float32 : t -> (float32[@local_opt]) @@ portable
    = "%float32_of_int8#"
  external to_float32_u : t -> float32_u @@ portable = "%float32#_of_int8#"
...
module String = struct
  ...
  external unsafe_get_float32_ne : (string[@local_opt]) -> int -> float32_u
  ...
  external unsafe_get_float32_ne_indexed_by_int64 :
    (string[@local_opt]) -> int64_u -> float32_u
