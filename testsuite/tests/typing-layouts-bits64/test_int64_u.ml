...
let () =
  ...
  test_division "%unsafe_unsigned_mod" Int64.unsigned_rem unsafe_unsigned_mod;
  ...
  let one_e_19_plus_42 = #0x8AC7_2304_89E8_002AL in
  (* = #10_000_000_000_000_000_042L,
     but we don't have unsigned decimal literals *)

  assert
    (I.equal
      (unsigned_div one_e_19_plus_42 #10_000L)
      #1_000_000_000_000_000L);
  assert
    (I.equal
      (unsigned_div one_e_19_plus_42 (id #10_000L))
      #1_000_000_000_000_000L);
  assert
    (I.equal
      (unsigned_div (id one_e_19_plus_42) #10_000L)
      #1_000_000_000_000_000L);
  assert
    (I.equal
      (unsigned_div (id one_e_19_plus_42) (id #10_000L))
      #1_000_000_000_000_000L);
  assert (I.equal (unsigned_mod one_e_19_plus_42 #10_000L) #42L);
  assert (I.equal (unsigned_mod one_e_19_plus_42 (id #10_000L)) #42L);
  assert (I.equal (unsigned_mod (id one_e_19_plus_42) #10_000L) #42L);
  assert (I.equal (unsigned_mod (id one_e_19_plus_42) (id #10_000L)) #42L);

  (* Test right-shift optimization *)
  assert
    (I.equal
      (unsigned_div #0xFFFF_FFFF_FFFF_FFFFL #256L)
      #0xFF_FFFF_FFFF_FFFFL);
  assert
    (I.equal
      (unsigned_div #0xFFFF_FFFF_FFFF_FFFFL (id #256L))
      #0xFF_FFFF_FFFF_FFFFL);
  assert
    (I.equal
      (unsigned_div (id #0xFFFF_FFFF_FFFF_FFFFL) #256L)
      #0xFF_FFFF_FFFF_FFFFL);
  assert
    (I.equal
      (unsigned_div (id #0xFFFF_FFFF_FFFF_FFFFL) (id #256L))
      #0xFF_FFFF_FFFF_FFFFL);
  assert (I.equal (unsigned_mod #0xFFFF_FFFF_FFFF_FFFFL #256L) #255L);
  assert (I.equal (unsigned_mod #0xFFFF_FFFF_FFFF_FFFFL (id #256L)) #255L);
  assert (I.equal (unsigned_mod (id #0xFFFF_FFFF_FFFF_FFFFL) #256L) #255L);
  assert (I.equal (unsigned_mod (id #0xFFFF_FFFF_FFFF_FFFFL) (id #256L)) #255L);
  ...
  assert (I.equal (unsigned_div #0x8000_0000_0000_0042L (id min_int)) #1L);
  assert (I.equal (unsigned_div (id #0x8000_0000_0000_0042L) min_int) #1L);
  assert (I.equal (unsigned_div (id #0x8000_0000_0000_0042L) (id min_int)) #1L);
  assert (I.equal (unsigned_mod #0x8000_0000_0000_0042L min_int) #0x42L);
  assert (I.equal (unsigned_mod #0x8000_0000_0000_0042L (id min_int)) #0x42L);
  assert (I.equal (unsigned_mod (id #0x8000_0000_0000_0042L) min_int) #0x42L);
  assert
    (I.equal (unsigned_mod (id #0x8000_0000_0000_0042L) (id min_int)) #0x42L);
