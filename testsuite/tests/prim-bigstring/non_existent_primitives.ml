...
external bigstring_get_64_unboxed : bigstring -> int -> int64_u
...
external bigstring_set_f32_by_int64 : bigstring -> int64_u -> float32_u -> unit
  = "%caml_bigstring_setf32u#_indexed_by_int64#"

[%%expect
{|
external bigstring_set_f32_by_int64 :
  bigstring -> int64_u -> float32_u -> unit
  = "%caml_bigstring_setf32u#_indexed_by_int64#"
|}]

external string_set_f32_by_int64 : string -> int64_u -> float32_u -> unit
  = "%caml_string_setf32u#_indexed_by_int64#"

[%%expect
{|
Lines 1-2, characters 0-45:
1 | external string_set_f32_by_int64 : string -> int64_u -> float32_u -> unit
