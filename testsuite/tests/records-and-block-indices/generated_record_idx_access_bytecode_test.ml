...
type t9 = { mutable a9 : int64; mutable b9 : int32_u } (* { int64; int32_u } *)
type t10 = { mutable a10 : int32_u } (* { int32_u } *)
type t11 = { mutable a11 : int32_u; mutable b11 : int } (* { int32_u; int } *)
type t12 = { mutable a12 : int32_u; mutable b12 : int32_u } (* { int32_u; int32_u } *)
type t13 = { mutable a13 : int32_u; mutable b13 : t5 } (* { int32_u; #{ int; int } } *)
type t14 = #{ a14 : int32_u } (* #{ int32_u } *)
type t15 = { mutable a15 : int32_u; mutable b15 : t14 } (* { int32_u; #{ int32_u } } *)
type t16 = #{ a16 : int32_u; b16 : int } (* #{ int32_u; int } *)
type t17 = { mutable a17 : int32_u; mutable b17 : t16 } (* { int32_u; #{ int32_u; int } } *)
type t18 = #{ a18 : int32_u; b18 : int32_u } (* #{ int32_u; int32_u } *)
type t19 = { mutable a19 : int32_u; mutable b19 : t18 } (* { int32_u; #{ int32_u; int32_u } } *)
type t20 = { mutable a20 : nativeint_u; mutable b20 : int64_u } (* { nativeint_u; int64_u } *)
type t21 = { mutable a21 : nativeint_u; mutable b21 : int32_u } (* { nativeint_u; int32_u } *)
...
type v43 = C43_0 of unit_u [@immediate_all_void_constructor] (* (| unit_u) *)
type t44 = { mutable a44 : v43 } (* { (| unit_u) } *)
type t45 = { mutable a45 : v43; mutable b45 : int64 } (* { (| unit_u); int64 } *)
type t46 = { mutable a46 : v43; mutable b46 : int64_u } (* { (| unit_u); int64_u } *)
type t47 = { mutable a47 : t3 } (* { #{ int } } *)
type t48 = { mutable a48 : t3; mutable b48 : int } (* { #{ int }; int } *)
type t49 = { mutable a49 : t5; mutable b49 : int32_u } (* { #{ int; int }; int32_u } *)
type t50 = #{ a50 : int; b50 : int32_u } (* #{ int; int32_u } *)
type t51 = { mutable a51 : t50; mutable b51 : int } (* { #{ int; int32_u }; int } *)
...
let to_run () =
  ...
  Idx_mut.set r ((.a9) : (t9, _) idx_mut) next_r.a9;
  mark_test_run 31;
  let test = eq r expected in
  if not test then failwithf "test 31 failed";
  mark_test_run 32;
  let test = sub_eq (Idx_mut.get r ((.a9) : (t9, _) idx_mut)) next_r.a9 in
  ...
  Idx_mut.set r ((.b9) : (t9, _) idx_mut) next_r.b9;
  mark_test_run 33;
  let test = eq r expected in
  ...
  Idx_mut.set r ((.b12) : (t12, _) idx_mut) next_r.b12;
  mark_test_run 43;
  let test = eq r expected in
  ...
  Idx_mut.set r ((.b13.#a5) : (t13, _) idx_mut) next_r.b13.#a5;
  mark_test_run 49;
  let test = eq r expected in
  if not test then failwithf "test 49 failed";
  mark_test_run 50;
  let test = sub_eq (Idx_mut.get r ((.b13.#a5) : (t13, _) idx_mut)) next_r.b13.#a5 in
  if not test then failwithf "test 50 failed";
  (* .b13.#b5 *)
  let sub_eq = (fun a b -> Int.equal a b) in
  let expected = { r with b13 = #{ r.b13 with b5 = next_r.b13.#b5 } } in
  Idx_mut.set r ((.b13.#b5) : (t13, _) idx_mut) next_r.b13.#b5;
  mark_test_run 51;
  let test = eq r expected in
  if not test then failwithf "test 51 failed";
  mark_test_run 52;
  let test = sub_eq (Idx_mut.get r ((.b13.#b5) : (t13, _) idx_mut)) next_r.b13.#b5 in
  ...
  Idx_mut.set r ((.b15.#a14) : (t15, _) idx_mut) next_r.b15.#a14;
  mark_test_run 57;
  let test = eq r expected in
  if not test then failwithf "test 57 failed";
  mark_test_run 58;
  let test = sub_eq (Idx_mut.get r ((.b15.#a14) : (t15, _) idx_mut)) next_r.b15.#a14 in
  if not test then failwithf "test 58 failed";
  (********************************************)
  (*   t17 = { int32_u; #{ int32_u; int } }   *)
  (********************************************)
  ...
  Idx_mut.set r ((.b17.#b16) : (t17, _) idx_mut) next_r.b17.#b16;
  mark_test_run 65;
  let test = eq r expected in
  if not test then failwithf "test 65 failed";
  mark_test_run 66;
  let test = sub_eq (Idx_mut.get r ((.b17.#b16) : (t17, _) idx_mut)) next_r.b17.#b16 in
  ...
  Idx_mut.set r ((.a20) : (t20, _) idx_mut) next_r.a20;
  mark_test_run 75;
  let test = eq r expected in
  if not test then failwithf "test 75 failed";
  mark_test_run 76;
  let test = sub_eq (Idx_mut.get r ((.a20) : (t20, _) idx_mut)) next_r.a20 in
  ...
  Idx_mut.set r ((.b20) : (t20, _) idx_mut) next_r.b20;
  mark_test_run 77;
  let test = eq r expected in
  if not test then failwithf "test 77 failed";
  mark_test_run 78;
  let test = sub_eq (Idx_mut.get r ((.b20) : (t20, _) idx_mut)) next_r.b20 in
  if not test then failwithf "test 78 failed";
  (**************************************)
  (*   t21 = { nativeint_u; int32_u }   *)
  (**************************************)
  ...
  Idx_mut.set r ((.b36) : (t36, _) idx_mut) next_r.b36;
  mark_test_run 141;
  let test = eq r expected in
  if not test then failwithf "test 141 failed";
  mark_test_run 142;
  let test = sub_eq (Idx_mut.get r ((.b36) : (t36, _) idx_mut)) next_r.b36 in
