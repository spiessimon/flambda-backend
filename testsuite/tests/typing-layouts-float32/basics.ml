...
let x3_1 : t_float32 = of_f32 #42.0s;;
[%%expect{|
val x3_1 : t_float32 = <abstr>
|}];;
...
module M3_4 = struct
  let x : t_float32 = of_f32 #42.0s
end
[%%expect{|
module M3_4 : sig val x : t_float32 end
|}];;
...
[%%expect{|
module type S6_1 = sig val x : t_float32 end
val f6 : (module S6_1) -> t_float32 = <fun>
|}];;
